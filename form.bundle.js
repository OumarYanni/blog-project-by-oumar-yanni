...
.content form .form-btn-container .btn {
  margin-left: 0.5rem;
}`, "",{"version":3,"sources":["webpack://./src/form/form.scss"],"names":[],"mappings":"AAAA;EACI,aAAA;EACA,uBAAA;EACA,mBAAA;AACJ;AAAI;EACI,iBAAA;EACA,gBAAA;EACA,WAAA;EACA,aAAA;EACA,6BAAA;EACA,kBAAA;EACA,aAAA;EACA,sBAAA;AAER;AADQ;EACI,mBAAA;EACA,aAAA;EACA,sBAAA;AAGZ;AAFY;EACI,iBAAA;EACA,oBAAA;EACA,gBAAA;EACA,mBAAA;AAIhB;AAFY;EACI,gCAAA;EACA,aAAA;EACA,UAAA;EACA,kBAAA;AAIhB;AAHgB;EACI,2BAAA;AAKpB;AAFY;EACI,iBAAA;AAIhB;AADQ;EACI,aAAA;EACA,yBAAA;EACA,mBAAA;AAGZ;AAFY;EACI,mBAAA;AAIhB","sourcesContent":[".content {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    form {\n        background: white;\n        max-width: 700px;\n        width: 100%;\n        padding: 4rem;\n        box-shadow: var(--box-shadow);\n        border-radius: 3px;\n        display: flex;\n        flex-direction: column;\n        .form-group {\n            margin-bottom: 2rem;\n            display: flex;\n            flex-direction: column;\n            label {\n                font-size: 1.8rem;\n                color: var(--accent);\n                font-weight: 700;\n                margin-bottom: 1rem;\n            }\n            input, textarea {\n                border: 1px solid var(--divider);\n                padding: 1rem;\n                outline: 0;\n                border-radius: 3px;\n                &:focus {\n                    border-color: var(--accent);\n                }\n            }\n            textarea {\n                min-height: 20rem;\n            }\n        }\n        .form-btn-container {\n            display: flex;\n            justify-content: flex-end;\n            align-items: center;\n            .btn {\n                margin-left: 0.5rem;\n            }\n        }\n    }\n}"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony import */ var _form_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./form.scss */ "./src/form/form.scss");
/* harmony import */ var _assets_javascripts_modal__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../assets/javascripts/modal */ "./src/assets/javascripts/modal.js");
...
btnCancel.addEventListener("click", async () => {
  const result = await (0,_assets_javascripts_modal__WEBPACK_IMPORTED_MODULE_6__.openModal)("Si vous quittez la page, vous allez perdre votre article");
  if (result) {
...
form.addEventListener("submit", async event => {
  ...
  if (formIsValid(article)) {
    try {
      ...
      let response;
      if (articleId) {
        response = await fetch("https://restapi.fr/api/article/".concat(articleId), {
          method: "PATCH",
          body: json,
          headers: {
